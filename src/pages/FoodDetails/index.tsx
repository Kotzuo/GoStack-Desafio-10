...
const FoodDetails: React.FC = () => {
  ...
  useEffect(() => {
    async function loadFood(): Promise<void> {
      const fetchedFood = (await api.get(`/foods/${routeParams.id}`)).data;
      ...
      setExtras(
        fetchedFood.extras.map((extra: Omit<Extra, 'quantity'>) => ({
          ...extra,
          quantity: 0,
        })),
      );
  ...
  function handleIncrementExtra(id: number): void {
    ...
    const extraIndex = newExtras.findIndex(e => e.id === id);
